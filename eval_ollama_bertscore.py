...
def create_visualizations(df: pd.DataFrame, output_prefix: str):
    ...
    ax.set_title('BERTScore Metrics Comparison', fontsize=14, fontweight='bold')
    ...
    ax.set_ylabel('Score', fontsize=12)
    ax.set_title('BERTScore Progression Across Samples', fontsize=14, fontweight='bold')
    ax.legend(loc='best')
    ax.grid(True, alpha=0.3)
    ...
    if 'kategori' in df.columns:
        ...
        if len(category_stats) > 0:
            ...
            ax.set_title('Average BERTScore by Category', fontsize=14, fontweight='bold')
    ...
    ax.set_ylabel('Score', fontsize=12)
    ax.set_title('BERTScore Summary Statistics', fontsize=14, fontweight='bold')
    ax.set_ylim(0, 1.0)
    ax.grid(True, axis='y', alpha=0.3)
    plt.tight_layout()
...
def main():
    ...
    p.add_argument("--model-name", default=os.environ.get("OLLAMA_MODEL", "llama3.2"), help="Ollama model name")
    ...
    p.add_argument("--bert-model", default=os.environ.get("BERT_MODEL", "indobenchmark/indobert-base-p2"))
